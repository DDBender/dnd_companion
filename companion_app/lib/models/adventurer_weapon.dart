...
class AdventurerWeapon {
  ...
  AdventurerWeapon({
    ...
    required this.enhancementBonus,
    this.enchantmentIds,
  ...
  factory AdventurerWeapon.fromJson(Map<String, dynamic> json) {
    return AdventurerWeapon(
      id: json['id'],
      ...
      notes: json['notes'],
      isMasterwork: json['is_masterwork'] ?? false,
      enhancementBonus: json['enhancement_bonus'] ?? 0,
